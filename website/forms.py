...
class SignUpForm(UserCreationForm):
    ...
    primer_nombre = forms.CharField(label="", max_length=100, widget=forms.TextInput(attrs={'class':'form-control', 'placeholder': 'Primer Nombre'}))
    apellido = forms.CharField(label="", max_length=100, widget=forms.TextInput(attrs={'class':'form-control', 'placeholder': 'Apellido'})) 
    
    
    class Meta:
        model = User
        fields = ['username', 'primer_nombre', 'apellido', 'email','password1', 'password2']
